                        ...
                        <thead class="thead-light">
                            ...
                            <tbody class="barra">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{url('/personal/'.$producto->id.'/edit')}}" class="btn btn-primary botones">
                                            Editar  
                                        </a>
                                        <form class="botones" action="{{ url('/personal/'.$producto->id )}}" method="POST">
                                            @csrf
                                            {{ method_field('DELETE')}}
